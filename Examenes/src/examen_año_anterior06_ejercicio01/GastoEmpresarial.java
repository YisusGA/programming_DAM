...
public class GastoEmpresarial extends ApunteEconomico {
	...
	public GastoEmpresarial(int code, double importe, String concepto, LocalDate fecha,
			String dNIResponsable) {
	...
	public String toString() {
		return "GastoEmpresarial [code=" + code + ", importe=" + importe + ", concepto=" + concepto + ", fecha=" + fecha + ", DNIResponsable=" + DNIResponsable + "]";
	}
