...
//Modificador public para la clase: permite qeu clases fuera del paqueta puedan hacer referencia a esa clase.
...
public class Alumno {
	...
	//La propiedad id no sería pública tal y como está escrita
	int id;
	...
	public boolean idSobreCien() {
		return id > 100; //Se puede acceder a id, aunque 
	}
