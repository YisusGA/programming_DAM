...
public class Ejercicio01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Introduce un número entero para conocer el tamaño en bytes de cada parte");
		int chunkSize = TecladoOK.leerEntero();
		int partes = 0;
		try {
			if ((partes = Ejercicio01DividirFichero.dividirFichero(inputFile, chunkSize)) != 0) {
				System.out.println("Fichero dividido con éxito en " + partes);
			} else {
				System.err.println("El fichero no existe, la dirección introducida no se corresponde a un fichero o el fichero tiene tamaño 0");
			}
		} catch (IOException e) {
