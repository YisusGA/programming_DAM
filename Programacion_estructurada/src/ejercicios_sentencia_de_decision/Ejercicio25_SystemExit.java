...
public class Ejercicio25_SystemExit {
	...
	public static void main(String[] args) {
		...
		if (year < 0 || month < 0 || day < 0) {
			...
			if (month < 1 || month > 12) {
				...
				// Con este System.exit(0), lo que hacemos es conseguir una salida del programa controlada (0), para que termine
				//el programa en ese punto y no siga evaluando todo lo que venga después. En este caso concreto, lo que conseguimos
				//evitar anidar tantos else if, porque si se cumple el if donde está este comentario, terminará sin evaluar el siguiente.
				//Lo mismo sucede si no se cumple este if pero se cumple el if de debajo.
				System.exit(0); 
			}	
			if (day < 1 || day > 31) {
