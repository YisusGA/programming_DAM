...
/**
 * 16.	Pedir 10 números, y mostrar al final si se ha introducido alguno negativo. Salir del bucle en cuanto se haya introducido un número negativo
 */

import java.util.Scanner;

public class Ejercicio16_break {
	...
	public static void main(String[] args) {
		...
		/*
		 * El break rompe el bucle y se sale. Es algo feo y poco legible, y no se suele usar,
		 *  pero haría lo mismo que la versión Ejercicio16_salida_negativo
		 */
		for (int i = 0; i < 10; i++) {
