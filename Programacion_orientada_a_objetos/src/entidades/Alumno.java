...
public class Alumno {
	...
	Matricula matricula; //Esta sería la forma de relacionar la clase Matricula con la clase Alumno. Una matrícula no tiene sentido de existencia si
	//no va asociada a un alumno. Por tanto, dentro de la clase Alumno, podemos meterle un tipo de dato objeto (Matrícula) para que ahora pertenezca a
	//él también
	
	//Métodos: códigos que los objetos alumno, creados en tiempo de ejecucion, pueden llamar
	
	//Método que se limita a mostrar por consola algo, no devuelve ningún valor. Como no devuevle ningún valor, ponemos el void
	void esMayorEdad() { //De momento, los paréntesis se quedan vacíos, pero ya los llevaremos
